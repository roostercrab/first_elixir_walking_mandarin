defmodule WalkingMandarinWeb.UsersAuthTest do
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, WalkingMandarinWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_users/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      WalkingMandarinWeb.Endpoint.subscribe(live_socket_id)
      ...
      assert_receive %Phoenix.Socket.Broadcast{
        event: "disconnect",
        topic: "user_sessions:abcdef-token"
      }
    end
