defmodule WalkingMandarinWeb.UsersAuth do
  import Plug.Conn
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "users_remember_me"
  ...
  If you want to enforce the users e-mail is confirmed before
  ...
  defp maybe_store_return_to(%{method: "GET", request_path: request_path} = conn) do
    put_session(conn, :users_return_to, request_path)
  end
