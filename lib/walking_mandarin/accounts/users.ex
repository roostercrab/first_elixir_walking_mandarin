defmodule WalkingMandarin.Accounts.Users do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, WalkingMandarin.Repo)
  ...
  @doc """
  A users changeset for changing the e-mail.
  ...
  """
  def password_changeset(users, attrs) do
    users
    |> cast(attrs, [:password])
  ...
  """
  def valid_password?(%WalkingMandarin.Accounts.Users{hashed_password: hashed_password}, password)
